...
- Include 1 or 2 relevant helpful links per day that are specific to that day's activities, such as official attraction pages, restaurant websites, or event listings; do not include generic travel resources
- Write 'Helpful links' on its own line
- Put each link on a new line underneath 'Helpful links'
- Only include a link if you are highly confident it is correct and official
- Do not guess or invent URLs !!Important!!!
- If unsure, write: None
- Prefer no link over a possibly incorrect link
...
- Choose the most practical and helpful links for that day's activities, prioritizing activities where the user might need to purchase tickets, make reservations, or find specific information
